...
const defaultConfig = Object.freeze({
  meta: null,
  // this parameter doesn't play any role as it's overidden in the index.html
  // also see ws proxy config in webpack.config.cjs
  signalingServerUrl: 'removeme ---- wss://gst-webrtc-signalling-service:9090/webrtc',
  reconnectionTimeout: 2500,
  webrtcConfig: {
    iceServers: [
      {
        urls: [
          // "stun:coturn-service:3478",
